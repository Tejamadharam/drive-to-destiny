...
namespace resume1
{
    public partial class resume : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string query = "Select *from resume1";
        ...
        {
            con.Open();
            SqlCommand com = new SqlCommand("select Contact_No,Name,Spacial_Skills,Resume_Name,type,data from  resume1 where id=@id", con);
